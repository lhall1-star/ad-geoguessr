...
// ── US / CANADA REGIONS ──────────────────────────────────────
// Update count when a US state, Canadian province, or territory appears.
// type: 'us' = US state, 'ca' = Canadian province/territory

const US_CANADA_REGIONS = [
  // US States
  { name:'Alabama',         type:'us', count:0 },
  { name:'Alaska',          type:'us', count:0 },
  { name:'Arizona',         type:'us', count:0 },
  { name:'Arkansas',        type:'us', count:0 },
  { name:'California',      type:'us', count:0 },
  { name:'Colorado',        type:'us', count:1 },
  { name:'Connecticut',     type:'us', count:0 },
  { name:'Delaware',        type:'us', count:0 },
  { name:'Florida',         type:'us', count:0 },
  { name:'Georgia',         type:'us', count:0 },
  { name:'Hawaii',          type:'us', count:0 },
  { name:'Idaho',           type:'us', count:1 },
  { name:'Illinois',        type:'us', count:0 },
  { name:'Indiana',         type:'us', count:0 },
  { name:'Iowa',            type:'us', count:0 },
  { name:'Kansas',          type:'us', count:0 },
  { name:'Kentucky',        type:'us', count:0 },
  { name:'Louisiana',       type:'us', count:0 },
  { name:'Maine',           type:'us', count:0 },
  { name:'Maryland',        type:'us', count:0 },
  { name:'Massachusetts',   type:'us', count:0 },
  { name:'Michigan',        type:'us', count:0 },
  { name:'Minnesota',       type:'us', count:0 },
  { name:'Mississippi',     type:'us', count:0 },
  { name:'Missouri',        type:'us', count:0 },
  { name:'Montana',         type:'us', count:0 },
  { name:'Nebraska',        type:'us', count:0 },
  { name:'Nevada',          type:'us', count:0 },
  { name:'New Hampshire',   type:'us', count:0 },
  { name:'New Jersey',      type:'us', count:0 },
  { name:'New Mexico',      type:'us', count:0 },
  { name:'New York',        type:'us', count:0 },
  { name:'North Carolina',  type:'us', count:0 },
  { name:'North Dakota',    type:'us', count:1 },
  { name:'Ohio',            type:'us', count:2 },
  { name:'Oklahoma',        type:'us', count:0 },
  { name:'Oregon',          type:'us', count:0 },
  { name:'Pennsylvania',    type:'us', count:0 },
  { name:'Rhode Island',    type:'us', count:0 },
  { name:'South Carolina',  type:'us', count:0 },
  { name:'South Dakota',    type:'us', count:0 },
  { name:'Tennessee',       type:'us', count:0 },
  { name:'Texas',           type:'us', count:0 },
  { name:'Utah',            type:'us', count:0 },
  { name:'Vermont',         type:'us', count:0 },
  { name:'Virginia',        type:'us', count:0 },
  { name:'Washington',      type:'us', count:0 },
  { name:'West Virginia',   type:'us', count:0 },
  { name:'Wisconsin',       type:'us', count:0 },
  { name:'Wyoming',         type:'us', count:0 },
  // Canadian Provinces & Territories
  { name:'Alberta',                   type:'ca', count:0 },
  { name:'British Columbia',          type:'ca', count:0 },
  { name:'Manitoba',                  type:'ca', count:0 },
  { name:'New Brunswick',             type:'ca', count:0 },
  { name:'Newfoundland and Labrador', type:'ca', count:0 },
  { name:'Nova Scotia',               type:'ca', count:0 },
  { name:'Ontario',                   type:'ca', count:1 },
  { name:'Prince Edward Island',      type:'ca', count:0 },
  { name:'Quebec',                    type:'ca', count:0 },
  { name:'Saskatchewan',              type:'ca', count:0 },
  { name:'Northwest Territories',     type:'ca', count:0 },
  { name:'Nunavut',                   type:'ca', count:0 },
  { name:'Yukon',                     type:'ca', count:0 },
];
